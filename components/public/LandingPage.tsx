...
export function LandingPage({ onGetStarted }: LandingPageProps) {
    ...
    const [showExpiredBanner, setShowExpiredBanner] = React.useState(sessionExpired);
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
            ...
            {/* Navigation Header */}
            <nav className={`bg-white border-b border-gray-200 sticky ${showExpiredBanner ? 'top-12' : 'top-0'} z-50 backdrop-blur-sm bg-white/90 transition-all`}>
